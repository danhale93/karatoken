          ...
          <View style={styles.form}>
            ...
            <View style={styles.quickAccess}>
              <TouchableOpacity 
                ...
                disabled={loading}
              >
                <Text style={styles.quickButtonText}>Continue to Profile Setup</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity 
                ...
                disabled={loading}
              >
                <Text style={styles.quickButtonText}>Try Live Pitch Scoring</Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={styles.footer}>
            <Text style={styles.footerText}>
              ...
              <Text 
                ...
                onPress={loading ? undefined : () => router.push('/login')}
              >
                Sign In
              </Text>
            </Text>
